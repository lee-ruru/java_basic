...
public class Warrior {//정의주, 실제 실행은 Main에서 할예정임.
	...
	// 생성자 규칙 : 클래스 명과 동일한 이름의 메서드를 만들되, 리턴자료형이 없음.
  public  Warrior(String n)  {
		...
		//hunt 메서드를 만들어보갰습니다.
		// 이메서드는 실행시 사냥을 하는데 체력이 2깍이고 경험치가 10올라갑니다.
		// 사냥 결과 페력이 X이 되었고, 누적 경험치는 Y입니다.라고 출력합니다.
		// 생성자를 비롯한 메서드는 행동을 나타내고
		// 이런 행동의 성공/실패 여부는 오로지 정보(변수)애의해 결정되며
