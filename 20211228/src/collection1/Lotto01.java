...
public class Lotto01 {
	...
	public static void main(String[] args) {
		...
		//ArrayList의 절렬은 .sort()대신
		//Collestions.sort(ArryList)를 사용합니다.
				
		//Integer를 저장받는 변 ArrayList 만들기
		List<Integer> lotto = new ArrayList<>();
		
		//로또 번호를 받을 수 있는 변수 생성후 0으로 초기화
		int getNum = 0;
		// while문 조건은 번호를 담은  ArrayList의 내부 요소 개수가 6이되면 종료되도록
		while(lotto.size() != 6) {
			// 번호 뽑기
